...
const Starter = () => {
  return (
    <>
      ...
      <div className="flex flex-col w-full px-5 md:hidden max-w-[95%] space-y-4 items-center justify-center pt-[9rem]">
        <IconsMobile/>

        <div className="flex flex-col w-[378px] max-w-[95%] space-y-5">
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.2, duration: 0.8 }}
              className="text-center text-[48px] font-geist font-medium leading-[3.5rem] text-[#191918]"
            >
              Get Active, Stay Healthy, and Win Rewards.
            </motion.p>
            <motion.p
          ...
          >
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-[266px] h-[48px] rounded-[41.77px] bg-[#191918] cursor-pointer border-[1px] border-transparent hover:border-white transition ease-in-out flex items-center justify-center space-x-1"
            >
              <TelegramIcon />
              <p className="text-white text-[16.71px]">Join on Telegram</p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-[266px] h-[48px] rounded-[41.77px] bg-[#FBFAF9] cursor-pointer border-[1px] border-transparent hover:border-black transition ease-in-out flex items-center justify-center space-x-1"
            >
              <TwitterIcon />
              <p className="text-[#080808] text-[16.71px]">Follow on twitter</p>
            </motion.div>
