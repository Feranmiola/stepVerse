...
const HowItWorks: React.FC = () => {
  ...
  return (
    ...
    <motion.div 
      initial="initial"
      animate="animate"
      className="w-full flex py-20 max-w-[95%] px-5 items-center md:hidden justify-center"
    >
      <div className=" w-full flex flex-col space-y-10">
        ...
        >
          ...
          <motion.p 
            className="text-[24px] w-[253px] font-medium font-inter leading-none"
            variants={contentVariants}
            transition={{ delay: 0.4, duration: 0.5 }}
          >
            Transform Your Health, One Step at a Time.
        ...
        <div className="flex w-full justify-between flex-col space-y-3 items-center">
          {[0, 1, 2].map((index) => (
            <motion.div
              key={index}
              onMouseEnter={() => handleMouseEnter(index)}
            ...
            >
              ...
              <motion.div 
                className="flex flex-col w-full h-[101px] justify-between"
                variants={contentVariants}
                transition={{ delay: index * 0.3, duration: 0.5 }}
              >
                <p className="text-[19px] font-semibold text-[#191918]">
