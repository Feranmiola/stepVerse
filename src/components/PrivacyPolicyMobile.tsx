      ...
      <div className="flex w-full px-5">
        <div className="flex flex-col space-y-5 w-full">
          <div className="flex flex-col space-y-2">
            <p className="w-[231px] leading-none text-[#191918] text-[32px] font-inter font-medium">
          ...
          <p className="w-full text-[#4C4C4C] text-base leading-tight">
            ...
            are our top priorities. This Privacy Policy outlines how we collect,
            use, store, and protect your personal data when you access and use
            our platform. By using StepVerse, you consent to the practices
            described in this document.
          </p>

          <div className="flex flex-col space-y-10">
            <div className="flex flex-col space-y-2 w-full">
              <p className="text-[18px] text-[#191918] font-medium font-inter">
                1. Data We Collect
              </p>
              <p className="w-full text-[#4C4C4C] text-base leading-tight">
              ...
              <ul className="w-full pl-4 space-y-2">
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
                  <span className="text-black">Contact Information:</span> Email
                  addresses or Telegram usernames for account creation and
                  communication.
                </li>
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
            ...
            <div className="flex flex-col space-y-2 w-full">
              ...
              <ul className="w-full pl-4 space-y-2">
                ...
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
                  <span className="text-black">Data Sharing:</span> You control
                  when and with whom your data is shared.
                </li>
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
                ...
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
                  ...
                  request the permanent deletion of your personal data, subject
                  to applicable laws.
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col space-y-2 w-full">
              ...
              <ul className="w-full pl-4 space-y-2">
                ...
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
                  <span className="text-black">Fraud Prevention:</span> Advanced
                  algorithms detect and prevent artificially inflated steps or
            ...
            <div className="flex flex-col space-y-2 w-full">
              ...
              <p className="w-full text-[#4C4C4C] text-base leading-tight">
                To enhance functionality, we may partner with third parties. Any
                data shared with third parties is anonymized and strictly
            ...
            <div className="flex flex-col space-y-2 w-full">
              ...
              <ul className="w-full pl-4 space-y-2">
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
                  Users receive clear and concise information on how their data
                  is used.
                </li>
                <li className="w-full text-[#4C4C4C] text-base leading-tight">
            ...
            <div className="flex flex-col space-y-5 w-full">
              ...
              <p className="w-full text-[#4C4C4C] text-base leading-tight">
                ...
                inquiries promptly. Whether you’re seeking clarification on how
                your data is used, requesting access to your data, or initiating
                a data deletion request, our team is here to help.
              </p>

              <p className="w-full text-[#4C4C4C] text-base leading-tight">
                Your privacy and trust are at the heart of StepVerse, and we are
                dedicated to providing you with a secure and transparent
