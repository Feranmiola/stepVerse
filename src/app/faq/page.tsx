...
export default function FAQPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "StepVerse aims to improve cardiovascular health, promote weight management, and enhance mental well-being by encouraging users to walk and stay active daily. Its gamified elements provide motivation, making fitness enjoyable while fostering long-term adherence to healthier habits."
    },
    {
      question: "How does StepVerse protect my personal data?",
      answer: "StepVerse employs advanced encryption techniques and adheres to strict privacy standards to protect user data. Only anonymized data is shared for research or analytics purposes. All transactions are secure, and users maintain full control over their personal health data."
    },
    {
      question: "What regions is StepVerse targeting for its initial launch?",
      answer: "StepVerse plans to target Africa, Southeast Asia, and Latin America for its initial rollout while it is available to use anywhere in the world. These regions have a high prevalence of sedentary lifestyles and limited access to affordable healthcare. By addressing these challenges, StepVerse hopes to create significant social and economic impacts."
    },
    {
      question: "Can StepVerse integrate with my wearable device?",
      answer: "At the initial rollout, StepVerse was not built to integrate with wearable devices like Fitbit, Apple Watch, and Garmin. However, this is one of the important updates that are lined up in the future releases to improve user experience."
    },
    {
      question: "What is the economic sustainability model of StepVerse?",
      answer: "StepVerse's sustainability relies on its tokenized ecosystem, which incentivizes users and generates revenue through in-app purchases, partnerships with fitness brands, and corporate wellness programs. The platform avoids a Ponzi-like model by focusing on utility-driven value rather than speculative growth."
    },
    {
      question: "How can I join the StepVerse community?",
      answer: "You can join the StepVerse community to stay updated on new features, competitions and announcements by joining our Telegram Channel and following us on Twitter (X)."
    }
  ];
