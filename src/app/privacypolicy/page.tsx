...
export default function PrivacyPolicy() {
  return (
    <div className="pt-[8rem] pb-20 flex items-center justify-center flex-col">
      <div className="flex flex-row  h-[2968px] w-[1201px] justify-between">
        <div className="flex flex-col space-y-5 w-[691px]">
        ...
        <div className="w-[344px] h-[372px] rounded-2xl bg-[#FBFAF9] px-5 flex flex-col justify-evenly">
            <p className="text-[#00BF3F] text-[13px]">Table of Contents</p>
            <ol className=" space-y-1 pl-5">
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Data We Collect</li>
                <li className="text-sm font-inter font-bold text-black">How We Use Your Data</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Transparency in Data Usage</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">User Rights and Control</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Data Security Measures</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Decentralized Ownership of Rewards</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Compliance with Global Standards</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Fraud Prevention and Fairness</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Third-Party Integrations</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">User Communication and Updates</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Children’s Privacy</li>
                <li className="text-sm font-inter font-normal text-[#6F6F6F]">Contact Us</li>
            </ol>
